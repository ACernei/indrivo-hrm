...
namespace InDrivoHRM.Pages
{
    public partial class AddTaskStatusComponent : ComponentBase
    {
        ...
        InDrivoHRM.Models.Crm.TaskStatus _taskstatus;
        protected InDrivoHRM.Models.Crm.TaskStatus taskstatus
        {
            get
            {
                return _taskstatus;
        ...
        {
            taskstatus = new InDrivoHRM.Models.Crm.TaskStatus(){};
        }

        protected async System.Threading.Tasks.Task Form0Submit(InDrivoHRM.Models.Crm.TaskStatus args)
        {
            try
            {
