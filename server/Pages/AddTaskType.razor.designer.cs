...
namespace InDrivoHRM.Pages
{
    public partial class AddTaskTypeComponent : ComponentBase
    {
        ...
        InDrivoHRM.Models.Crm.TaskType _tasktype;
        protected InDrivoHRM.Models.Crm.TaskType tasktype
        {
            get
            {
                return _tasktype;
        ...
        {
            tasktype = new InDrivoHRM.Models.Crm.TaskType(){};
        }

        protected async System.Threading.Tasks.Task Form0Submit(InDrivoHRM.Models.Crm.TaskType args)
        {
            try
            {
