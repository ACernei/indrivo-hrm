...
namespace InDrivoHRM.Pages
{
    public partial class TaskStatusesComponent : ComponentBase
    {
        ...
        protected RadzenDataGrid<InDrivoHRM.Models.Crm.TaskStatus> grid0;
        ...
        protected async System.Threading.Tasks.Task Grid0RowSelect(InDrivoHRM.Models.Crm.TaskStatus args)
        {
