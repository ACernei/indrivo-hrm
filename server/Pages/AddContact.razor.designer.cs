...
namespace InDrivoHRM.Pages
{
    public partial class AddContactComponent : ComponentBase
    {
        ...
        InDrivoHRM.Models.Crm.Contact _contact;
        protected InDrivoHRM.Models.Crm.Contact contact
        {
            get
            {
                return _contact;
        ...
        {
            contact = new InDrivoHRM.Models.Crm.Contact(){};
        }

        protected async System.Threading.Tasks.Task Form0Submit(InDrivoHRM.Models.Crm.Contact args)
        {
            try
            {
